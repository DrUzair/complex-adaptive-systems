...
to go
  ...
  if all? turtles [ not is_infected? ][stop]
  ...
  set cumsum-infected-child cumsum-infected-child +  count turtles with [ is_infected? and age-group = "child"]
  set cumsum-infected-teen  cumsum-infected-teen + count turtles with [ is_infected? and age-group = "teen"]
  set cumsum-infected-adult cumsum-infected-adult +  count turtles with [ is_infected? and age-group = "middle-age"]
  set cumsum-infected-old  cumsum-infected-old + count turtles with [ is_infected? and age-group = "old"]
...
to maybe-show-symptoms
  if random-float 100 < show-symptoms-chance [
    let r random-normal show-symptoms-time 1 ;; random-normal mean sd
    if (ticks - infected_on) > r and not show_symptoms? [
...
"middle-age" 1.0 0 -6459832 true "" "histogram [travel] of turtles with [age-group = \"middle-age\"]"
...
<experiments>
  <experiment name="experiment" repetitions="1" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>(count turtles with [age-group = "child" and is_infected? or is_cured?])</metric>
    <metric>count turtles with [age-group = "teen" and is_infected? or is_cured?]</metric>
    <metric>count turtles with [age-group = "middle-age" and is_infected? or is_cured?]</metric>
    <metric>count turtles with [age-group = "old" and is_infected? or is_cured?]</metric>
    <metric>R0</metric>
    ...
    <enumeratedValueSet variable="restrict-mobility">
      <value value="&quot;all&quot;"/>
      <value value="&quot;no&quot;"/>
    </enumeratedValueSet>
